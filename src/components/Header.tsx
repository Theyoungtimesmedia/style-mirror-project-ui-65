...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-md border-b border-red-500/20">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link 
              to="/" 
              className="relative text-white hover:text-red-400 transition-colors duration-300 group font-['Inter'] font-medium"
            >
              Home
            ...
            <a 
              ...
              className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-full transition-all duration-300 hover:scale-105 flex items-center space-x-2 font-['Inter'] font-medium"
            >
              <Phone size={16} />
              <span>WhatsApp</span>
            </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 py-4 border-t border-red-500/20 animate-fade-in">
            <nav className="flex flex-col space-y-4">
              <Link 
                to="/" 
                className="text-white hover:text-red-400 transition-colors duration-300 font-['Inter']"
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-full transition-all duration-300 text-center flex items-center justify-center space-x-2 font-['Inter']"
              >
                <Phone size={16} />
                <span>WhatsApp</span>
              </a>
