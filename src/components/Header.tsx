...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-gray-900/90 via-purple-900/90 to-blue-900/90 backdrop-blur-md border-b border-cyan-400/20">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <button 
            onClick={toggleMenu}
            className="md:hidden text-white hover:text-cyan-400 transition-colors duration-300 hover:scale-110"
          >
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 py-4 border-t border-cyan-400/20 animate-fade-in">
            <nav className="flex flex-col space-y-4">
              <Link 
                to="/" 
                className="text-white hover:text-cyan-400 transition-colors duration-300 hover:pl-2"
            ...
            <div className="flex items-center space-x-4 mt-4 pt-4 border-t border-cyan-400/20">
              <a 
                href="https://www.facebook.com/DjbidexBidex" 
                target="_blank" 
                rel="noopener noreferrer"
