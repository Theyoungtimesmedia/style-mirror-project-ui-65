      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {releases.map((release, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl mb-6 shadow-xl hover:shadow-2xl transition-all duration-500 bg-black">
                <img 
                  src={release.image} 
                  alt={release.title}
                ...
                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-all duration-300 flex items-center justify-center">
                  <div className="transform scale-0 group-hover:scale-100 transition-transform duration-300">
                    <div className="flex space-x-3">
                      <button className="bg-red-600 hover:bg-red-700 text-white rounded-full p-3 transition-all duration-300 hover:scale-110">
                        <Play size={20} />
                      </button>
        ...
        <div className="text-center mt-12 animate-fade-in delay-500">
          <button className="group bg-red-600 hover:bg-red-700 text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-xl flex items-center space-x-2 mx-auto">
